...
setup_test_environment() {
  ...
  export FETCH_START_CHECK_PORT="1"
  export FETCH_START_REQUIRE_ODOO="1"
  export FETCH_START_REQUIRE_BACKUP="1"
  export FETCH_START_REQUIRE_ADDONS="1"
  export FETCH_START_FORCE_REDOWNLOAD="0"
  export BACKUP_INPUT=""
